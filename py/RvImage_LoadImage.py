...
class RvImage_LoadImage:
	...
	def load_image(self, image: str) -> Tuple[torch.Tensor, torch.Tensor, Dict[str, Any]]:
		...
		# Extract metadata and create pipe
		prompt = ""
		negative = ""
		generation_data = "{}"
		steps = 0
		...
		seed = 0
		model_hash = ""
		model_hashes = {}  # Initialize model_hashes to avoid NameError
		version = ""
		...
		return (output_image, output_mask, pipe)
...
NODE_NAME = 'Load Image (Metadata Pipe) [Eclipse]'
NODE_DESC = 'Load Image (Metadata Pipe)'

NODE_CLASS_MAPPINGS = {
   NODE_NAME: RvImage_LoadImage
}
