...
class RvSettings_Sampler_Settings:
    ...
    def execute(self, allow_overwrite: bool, sampler_name: Any, scheduler: Any, steps: int, cfg: float, guidance: float, denoise: float) -> Tuple:
...
NODE_NAME = 'Sampler Settings [Eclipse]'
NODE_DESC = 'Sampler Settings'

NODE_CLASS_MAPPINGS = {
   NODE_NAME: RvSettings_Sampler_Settings
}
