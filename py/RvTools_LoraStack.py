...
class RvTools_LoraStack:
    ...
    def INPUT_TYPES(cls):
        ...
        return {"required": {
                    "simple": ("BOOLEAN", {"default": False, "tooltip": "When enabled, hides clip_weight widgets and uses model_weight for both"}),
