    ...
    def execute(self, allow_overwrite: bool, sampler_name: str, scheduler: str, steps: int, cfg: float, guidance: float,
        ...
        if seed in (-1, -2, -3):
            ...
            if unique_id is None:
                cstr('RvSettings_Sampler_Settings_NI_Seed', 'Cannot save server-generated seed to image metadata because ' +
                     'the node\'s id was not provided.').warning.print()
            else:
                if extra_pnginfo is None:
                    cstr('RvSettings_Sampler_Settings_NI_Seed', 'Cannot save server-generated seed to image workflow ' +
                ...
                if prompt is None:
                    cstr('RvSettings_Sampler_Settings_NI_Seed', 'Cannot save server-generated seed to image API prompt ' +
...
NODE_NAME = 'Sampler Settings NI+Seed [RvTools]'
