...
class RvSettings_Sampler_Settings_Small_Seed:
    ...
    def execute(self, allow_overwrite: bool, sampler_name: Any, scheduler: Any, steps: int, cfg: float, seed: int = 0, prompt=None, extra_pnginfo=None, unique_id=None) -> Tuple:
        ...
        if seed in (-1, -2, -3):
            ...
            if unique_id is None:
                cstr('RvSettings_Sampler_Settings_Small_Seed', 'Cannot save server-generated seed to image metadata because ' +
                     'the node\'s id was not provided.').warning.print()
            else:
                if extra_pnginfo is None:
                    cstr('RvSettings_Sampler_Settings_Small_Seed', 'Cannot save server-generated seed to image workflow ' +
                ...
                if prompt is None:
                    cstr('RvSettings_Sampler_Settings_Small_Seed', 'Cannot save server-generated seed to image API prompt ' +
...
NODE_CLASS_MAPPINGS = {
   NODE_NAME: RvSettings_Sampler_Settings_Small_Seed
}
