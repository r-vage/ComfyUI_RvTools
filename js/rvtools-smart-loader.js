...
* Simplified loader without latent/sampler configuration
*/
    ...
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        ...
        nodeType.prototype.onNodeCreated = function () {
            ...
            const updateVisibility = () => {
                ...
                // Sampler Configuration - always visible (simplified loader)
                // Note: sampler_name, scheduler, steps, cfg, flux_guidance are always shown
